...
#I am opting to use ancova since I am looking at how multiple variables variables affect total spp. and for all of the models in this assignment I am using/assuming a normal distribution, since the variables are numeric, 
#all of the variables outside of year are continuous as well. 
